              ...
              <div className="h-[260px] w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={stats.userGrowth} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                    ...
                    <Tooltip contentStyle={{ backgroundColor: '#161c2a', borderColor: '#232d42', borderRadius: '12px' }} />
                    <Legend wrapperStyle={{ fontSize: '11px', paddingTop: '10px' }} />
                    <Line type="monotone" dataKey="users" name="Accounts" stroke="#7c3aed" strokeWidth={3} />
                  </LineChart>
                </ResponsiveContainer>
              </div>
            </div>
                ...
                {stats.stageDistribution.length === 0 ? (
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={stats.stageDistribution} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                      ...
                      <YAxis stroke="#9ca3af" fontSize={11} />
                      <Tooltip contentStyle={{ backgroundColor: '#161c2a', borderColor: '#232d42', borderRadius: '12px' }} />
                      <Bar dataKey="count" name="Diagnoses" fill="#06b6d4" radius={[6, 6, 0, 0]} />
                    </BarChart>
                  </ResponsiveContainer>
                )}
              </div>
        ...
        <div className="glass-card overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-[#111724] border-b border-dark-border">
              ...
              <tbody>
                {users.map((item) => (
                  <tr key={item._id} className="border-b border-dark-border/40 hover:bg-[#161c2a]/30 transition-colors">
